...
def _export_scored_entities(path: str | Path, rows: Iterable[object]) -> CsvExportResult:
...
def export_opportunities(path: str | Path, opps: Iterable[Opportunity]) -> CsvExportResult:
