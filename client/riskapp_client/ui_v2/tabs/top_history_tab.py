...
class TopHistoryTab(QWidget):
    ...
    def __init__(
        ...
        *,
        ...
        # --- CONTEXT HELP (EDITOR CONTROLS) ---
        self.ui.snapshot_btn.setToolTip("Manually capture a snapshot of the current top items")
        self.ui.auto_snapshot_chk.setToolTip("Enable automatic background snapshots")
        self.ui.auto_snapshot_kind.setToolTip("Select whether to auto-snapshot risks, opportunities, or both")
        self.ui.auto_snapshot_days.setToolTip("Set how often (in days) automatic snapshots are taken")
        
        self.ui.top_kind.setToolTip("Filter history table to show risks, opportunities, or both")
        self.ui.top_limit.setToolTip("Limit the number of top items displayed per snapshot")
        self.ui.top_period.setToolTip("Quickly select a time period for the history view")
