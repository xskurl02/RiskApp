...
class AssessmentsTab(QWidget):
    ...
    def __init__(self, *, on_save_assessment: Callable[[], None], parent=None) -> None:
        ...
        self.ui.assessments_table.setSizeAdjustPolicy(QAbstractScrollArea.AdjustToContents)
        self.ui.assessments_table.setSizePolicy(QSizePolicy.Maximum, QSizePolicy.Maximum)
        
        # SAFELY push the table to the top by adding a stretch to the table card's layout
        self.ui.verticalLayout_2.addStretch()

        # SAFELY push the editor controls to the top of the editor card
        self.ui.verticalLayout_3.addStretch()
        
        # --- FORCE 75/25 SPLIT (Table / Editor) ---
        ...
        self.assess_notes.setToolTip("Provide reasoning or evidence for your assessment scores")
